...
// @NOTE: Types
import { type RequestNewConfirmationCodeForm } from "../../types";
// @NOTE: Components
import ErrorMessage from "@/components/ErrorMessage";
// @NOTE: Services
import { requestNewConfirmationCode } from "@/services/AuthAPI";


export default function RegisterView() {
    const initialValues: RequestNewConfirmationCodeForm = {
        email: ''
    }
    ...
    const handleRequestCode = (formData: RequestNewConfirmationCodeForm) => mutate(formData);
