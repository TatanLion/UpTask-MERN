...
// @NOTE: Types
import type { CheckPasswordForm, Project } from '@/types/index';
...
export default function DeleteProjectModal() {
    ...
    // @NOTE: Mutación para verificar el password del usuario antes de eliminar el proyecto
    ...
    const deleteProjectAfterCheckPassword = useMutation({
    ...
    const handleForm = async (formData: CheckPasswordForm) => {
        ...
        await deleteProjectAfterCheckPassword.mutateAsync(deleteProjectId);
        // const response = await checkUserPasswordMutation.mutateAsync(formData);
